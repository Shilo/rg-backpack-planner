<svg {...$$restProps} viewBox="0 0 44 44" fill="none">
    <path
...
<style>
    ...
    path {
        fill: var(--root-gear-fill, currentColor);
        stroke: var(--root-gear-stroke, currentColor);
        stroke-width: var(--root-gear-stroke-width, 3);
