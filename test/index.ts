...
const TEST_FILES = [
    ...
    "composeImageViewerGestureSurface.test.ts",
    "imageViewerLayout.test.ts",
    "imageViewerClampAtFit.test.ts",
    "imageViewerResizeReset.test.ts",
    "imageViewerPinchStateParity.test.ts",
    "imageViewerOverlayGestureGuard.test.ts",
    "imageViewerPointerCaptureCleanup.test.ts",
