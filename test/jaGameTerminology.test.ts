...
const EXPECTED_TERMS: Record<string, string> = {
    ...
    "skills.short.attack_boost": "攻撃力強化",
    "skills.short.hp_boost": "HP強化",
    "skills.short.defense_boost": "防御力強化",
    "skills.short.global_def": "グローバル防御力",
    "skills.short.global_hp": "グローバルHP",
    "skills.short.final_damage_boost": "最終ダメージ",
    "skills.short.global_atk": "グローバル攻撃力",
    "skills.short.skill_crit": "スキルクリティカル",
    "skills.short.counterattack_resistance": "反撃耐性",
    "skills.short.critical_hit": "通常攻撃クリティカル",
    "skills.short.skill_crit_resistance": "スキルクリティカル耐性",
    "skills.short.damage_reflection_chance": "ダメージ反射率",
    ...
    "onboarding.budgetIgnoreDesc": "設定 > ノード > 研究クリスタル予算を無視で予算を無効化",
};
